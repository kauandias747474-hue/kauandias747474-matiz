...
Dedico meu tempo ao domínio da base, arquitetura e sistemas operacionais:
*Mastering the core, architecture, and operating systems:*
...
- **Java & Clean Code:** Arquitetura robusta e código limpo (S.O.L.I.D). *(Robust architecture and clean code).*
...
*Future steps - From automation to deep hardware:*
